...
Thumbnailer.prototype.bounded = function() {
	var dimensionsString = _this.width + 'X' + _this.height,
		thumbnailCommand = 'convert "' + _this.localPath + '" -thumbnail ' + dimensionsString + ' ' + _this.convertedPath;
...
Thumbnailer.prototype.fill = function() {
	var dimensionsString = _this.width + 'X' + _this.height,
		thumbnailCommand = 'convert "' + _this.localPath + '" -resize ' + dimensionsString + '^ -gravity center -extent ' + dimensionsString + ' ' + _this.convertedPath;
