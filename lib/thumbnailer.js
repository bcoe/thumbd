...
Thumbnailer.prototype.matted = function() {
	var thumbnailCommand = this.convert_command + ' "' + this.localPath + '[0]" -thumbnail ' + (this.width * this.height) + '@ -gravity center -background ' + this.background + ' -extent ' + this.width + 'X' + this.height + ' ' + this.convertedPath;
...
Thumbnailer.prototype.bounded = function() {
	var dimensionsString = this.width + 'X' + this.height,
		thumbnailCommand = this.convert_command + ' "' + this.localPath + '[0]" -thumbnail ' + dimensionsString + ' ' + this.convertedPath;
...
Thumbnailer.prototype.fill = function() {
	var dimensionsString = this.width + 'X' + this.height,
		thumbnailCommand = this.convert_command + ' "' + this.localPath + '[0]" -resize ' + dimensionsString + '^ -gravity center -extent ' + dimensionsString + ' ' + this.convertedPath;
