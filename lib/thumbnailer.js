...
Thumbnailer.prototype._guessStrategy = function() {
	if (this.strategy.indexOf('%(command)s') > -1) {
		return 'manual'
 ...
 *
 * The custom strategy will be evaluated with the following
 * keys passed to it:
...
Thumbnailer.prototype.manual = function() {
	var thumbnailCommand = sprintf(this.strategy, {
		command: this.command,
		localPaths: this.localPaths,
		convertedPath: this.convertedPath
	});
