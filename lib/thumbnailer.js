...
Thumbnailer.prototype.bounded = function() {
	var dimensionsString = this.width + 'X' + this.height,
		thumbnailCommand = 'convert "' + this.localPath + '[0]" -thumbnail ' + dimensionsString + ' ' + this.convertedPath;
...
Thumbnailer.prototype.fill = function() {
	var dimensionsString = this.width + 'X' + this.height,
		thumbnailCommand = 'convert "' + this.localPath + '[0]" -resize ' + dimensionsString + '^ -gravity center -extent ' + dimensionsString + ' ' + this.convertedPath;
